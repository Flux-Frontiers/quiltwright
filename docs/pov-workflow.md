...
povray.md section 2 for why narrowing the FOV makes ghosting *worse* rather than
...
**A preset's native cone is not a target.** section 6 said an open scene can use the
...
**opposite** directions about a stationary focal plane. povray.md section 4 has the
...
Portrait quilt -- about 2.75× coarser sampling. Everything section 7 says about
...
Then verify the parallax exactly as section 8 does. The frames are ordinary PNGs in
