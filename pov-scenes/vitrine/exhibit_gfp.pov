// GREEN FLUORESCENT PROTEIN in the standard vitrine.
//
// Render the still at the vitrine's own aspect (16:9 by default):
//   povray +Iexhibit_gfp.pov +W1920 +H1080 +Q11 +A0.3 \
...
#declare VIT_LABEL = "GREEN FLUORESCENT PROTEIN";
#include "vitrine.inc"
#include "gfp.inc"

Vitrine_Report()

Vitrine_Mount(gfp, gfp_enclosing_radius)
Vitrine_Case()
Vitrine_Plinth()
Vitrine_Room()
Vitrine_Lights()
