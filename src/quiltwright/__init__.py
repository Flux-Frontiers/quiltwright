...
_LAZY: dict[str, str] = {
    ...
    "camera_block": "povray",
    "toe_in_cameras": "povray",
    "litiholo_names": "quilt",
    "pack_litiholo_sweep": "quilt",
    "view_angles": "quilt",
    "camera_frame": "lfd",
    ...
    "depth_report": "lfd",
    "DynamicSpec": "dynamic",
    "AppearanceMap": "dynamic",
    "SolarItem": "dynamic",
    "TimeItem": "dynamic",
    "save_dynamic_heic": "dynamic",
    "read_dynamic_metadata": "dynamic",
    "sun_direction": "povray",
    "lighting_block": "povray",
    "APPEARANCE_SUN": "povray",
    "find_ffmpeg": "runtime",
    "focal_distance_for_range": "quilt",
    "frame_and_focus": "lfd",
    "format_depth_budget": "povray",
    "frame_camera": "cycles",
    "autoframe_camera": "cycles",
    "mesh_bounds": "cycles",
    "coalesce_mesh2": "povgen",
    "cycles_camera_from_plotter": "cycles",
    "export_plotter_gltf": "cycles",
    "fov_horizontal_to_vertical": "povgen",
    "fov_vertical_to_horizontal": "povgen",
    "hld_orbit_speed": "hld",
