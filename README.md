...
it end-to-end; the worked case study is [docs/povray.md](docs/povray.md).
...
Cycles) are in [docs/cycles.md](docs/cycles.md).
...
The results worth knowing before you frame a shot -- each derived in
