...
This is a *scene source*, the same role POV-Ray scenes and PyVista example
datasets play elsewhere in Quiltwright: it produces geometry, and says
...
_CACHE_ENV = "QUILTWRIGHT_TVB_CACHE"
...
def _read_member(member: str, *, quiet: bool = False) -> bytes:
    ...
    try:
        ...
        raise KeyError(
            ...
            f"from a different tvb-data release; delete it (quiltwright.tvb_data."
